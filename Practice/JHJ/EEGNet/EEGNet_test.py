...
checkpointer = ModelCheckpoint(filepath='D:/Artigence/tmp/checkpoint.h5', verbose=1,
                               save_best_only=True)
...
################################################################################
hist = model.fit(X_train, Y_train, batch_size = 16, epochs = 100,
                 verbose = 2, validation_split=0.33, shuffle=True,
                 callbacks=[checkpointer], class_weight = class_weights)

# load optimal weights
model.load_weights('D:/Artigence/tmp/checkpoint.h5')
